...
- Example: `com.yourname.youareexpert`
...
- **Value:** "This app needs camera access to [describe your specific use case]"
...
- **CalendarEvent.swift**: Core functionality
- **IngestionService.swift**: Core functionality
- **ScheduleEventIntent.swift**: Core functionality
- **CalendarViewModel.swift**: Custom view component
